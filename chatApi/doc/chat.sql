...
CREATE TABLE `ht_address_book`  (
  ...
  `be_focused_user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '被关注者用户编号',
  `focused_user_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '关注者用户编号',
  ...
  `unread_number` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '未读取信息次数',
...
CREATE TABLE `ht_admin`  (
  ...
  `uuid` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '唯一编号',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uuid`(`uuid`) USING BTREE COMMENT '唯一id'
...
CREATE TABLE `ht_msg`  (
  ...
  `send_status` tinyint(1) NOT NULL COMMENT '发送状态',
  `read_status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '读取状态',
  `user_type` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0是普通用户，1是管理员',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 523 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
