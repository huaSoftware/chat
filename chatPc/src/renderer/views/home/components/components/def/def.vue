 ...
 * @description: 功能栏页面
 * @LastEditors: hua
 * @LastEditTime: 2020-10-31 14:45:18
 -->
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide" style="padding:20px;padding-top:3px">
            <div class="yd-grids-raw">
              ...
              >
                <i  v-if="item.icon === 'video'" class="yd-grids-icon" custom slot="icon" name="liaotian" color="#00C2E6"></i>
                <i v-else class="yd-grids-icon" slot="icon" :name="item.icon" custom color="#00C2E6"></i>
