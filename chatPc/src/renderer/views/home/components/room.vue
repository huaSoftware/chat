...
<template>
  <div id="msg_empty">
    ...
    <div v-if="menuVisible" class="menu_container" :style="'top:'+menuTop+'px;right:1.4rem'">
       <div>
          <div @click.native="handleCopy">
              <span slot="text">复制</span>
          </div>
          <div @click.native="handleCallBackMsg">
              <span slot="text">撤回</span>
          </div>
          <div @click.native="handleResetSend">
    ...
    <el-dialog title="详情" :visible.sync="detailsVisible">
      <roomDetails @handleClose="handleDetailsClose" style="height: 300px;overflow: auto;" v-if="detailsVisible"></roomDetails>
    </el-dialog>
    <!-- 内容 -->
...
export default {
  ...
  methods: {
    ...
    handleCallBackMsg(){
      MessageBox.confirm("只能撤回远端记录，确认撤回？", {
